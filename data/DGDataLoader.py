...
VLCS_dataset = ["Caltech101","LabelMe","SUN09","VOC2007"]
Domain_net_dataset = ["clipart","infograph","painting","quickdraw","real","sketch"]
TerraIncognita_dataset = ["location_38", "location_43", "location_46", "location_100"]
available_datasets = pacs_dataset + officehome_dataset + digits_datset + VLCS_dataset + Domain_net_dataset + TerraIncognita_dataset
...
def get_fourier_train_dataloader(
    ...
    # print(len(dataset.flat_names))
    loader = DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=2, pin_memory=False,drop_last=True)
    return loader,len(dataset.flat_names)
