...
def get_args():
    ...
    parser.add_argument("--dataset", default="PACS", help="The directory to save logs and models")
    # parser.add_argument("--task", default="photo", help="The directory to save logs and models")
